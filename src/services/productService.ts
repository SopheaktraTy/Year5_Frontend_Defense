...
export const getProductById = async (productId: string) => {
  const response = await API.get(
    `/products/view-a-product/${productId}`,
    authHeader()
  )
...
export const updateProduct = async (
  ...
  const response = await API.put(
    `/products/update-a-product/${productId}`,
    updateData,
    authHeader()
  )
  return response.data
...
export const deleteProduct = async (productId: string) => {
  const response = await API.delete(
    `/products/remove-a-product/${productId}`,
    authHeader()
  )
  return response.data
}
...
export const createProductVariable = async (
  ...
  const response = await API.post(
    `/products/add-product-variables/${productId}`,
    variableData,
    authHeader()
  )
  return response.data
...
export const updateProductVariable = async (
  ...
  const response = await API.put(
    `/products/update-a-product-variable/${variableId}`,
    updateData,
    authHeader()
  )
  return response.data
...
export const deleteProductVariable = async (variableId: string) => {
  const response = await API.delete(
    `/products/remove-a-product-variable/${variableId}`,
    authHeader()
  )
  return response.data
}
