...
import { Truck, CreditCard, Shield, MessageCircle, FileText } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 text-sm mb-1">SAFE PAYMENT</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 text-sm mb-1">ONLINE DISCOUNT</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 text-sm mb-1">HELP CENTER</h3>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold text-gray-900 text-sm mb-1">CURATED ITEMS</h3>
      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* About the Store */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-4 text-sm">ABOUT THE STORE</h3>
              <div className="space-y-3">
                <p className="text-gray-600 text-sm">Got Question? Call us 24/7</p>
                <div className="text-blue-600 font-bold text-xl">+222-1800-262</div>
                <p className="text-gray-600 text-sm">268 St, Toulkork/ 12500, Phnom Penh</p>
                <p className="text-gray-600 text-sm">Customersupport@example.com</p>
              </div>
            </div>

            {/* Information */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-4 text-sm">INFORMATION</h3>
              <p className="text-gray-500 text-sm italic">You have not selected the footer menu</p>
            </div>
            ...
            {/* Newsletter Signup */}
            <div>
              <h3 className="font-semibold text-gray-900 mb-4 text-sm">NEWSLETTER SIGNUP</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm">
            <div className="text-gray-600 mb-4 md:mb-0">
              Copyright © <span className="text-blue-600 hover:underline cursor-pointer">Uminex</span> all rights reserved. 
              Powered by <span className="text-blue-600 hover:underline cursor-pointer">Alothemes</span>.
            </div>
